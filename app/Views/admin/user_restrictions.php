<div class="page-header">
    <h1>🔒 Restrictions compte — <?= e($targetUser['username']) ?></h1>
...
<div class="card mb-3">
    ...
    <div class="card-body">
        ...
        <p><strong>Role global :</strong> <?= e(global_role_label($targetUser['global_role'])) ?></p>

        <?php if (!empty($targetUser['restricted_at'])): ?>
            <div class="alert alert-warning mt-2">
                <strong>Restrictions actives depuis le <?= format_date($targetUser['restricted_at'], 'd/m/Y a H:i') ?></strong>
...
<form method="POST" action="/admin/users/<?= (int) $targetUser['id'] ?>/restrictions">
    ...
    <div class="card mb-3">
        <div class="card-header">
            <h3>Fonctionnalites a restreindre</h3>
        </div>
        <div class="card-body">
            <p class="text-muted text-small mb-2">Cochez les actions a bloquer pour ce compte utilisateur.</p>
