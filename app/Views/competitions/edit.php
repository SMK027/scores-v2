...
(function() {
    ...
    const preselectedIds = <?= json_encode(array_values(array_map('intval', $selectedGameTypeIds ?? []))) ?>;
    ...
    const form = document.querySelector('form[action*="/competitions/"]');
    const selectedIds = new Set(preselectedIds);
